...
AddEventHandler('esx_basicneeds:resetStatus', function()
	...
	TriggerEvent('esx_status:set', 'stress', 50000)
end)
...
AddEventHandler('esx_basicneeds:healPlayer', function()
	...
	TriggerEvent('esx_status:set', 'stress', 20000)
...
AddEventHandler('esx_status:loaded', function(status)
	...
	TriggerEvent('esx_status:registerStatus', 'stress', 20000, '#0C98F1', function(status)
		return false
	end, function(status)
		status.add(100)
	end)

...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            drawTxt(locationText, 4, locationColorText, 0.3, screenPosX -  0.150 , screenPosY + 0.083)
            ...
            if pedInVeh and GetIsVehicleEngineRunning(vehicle) and vehicleClass ~= 13 then
                ...
                if ShouldUseMetricMeasurements() then
                    ...
                    drawTxt(("%.3d"):format(math.ceil(speed)), 2, speedColor, 0.4, screenPosX - 0.040, screenPosY + 0.060)
                    drawTxt("KPH", 2, speedColorText, 0.4, screenPosX - 0.025, screenPosY + 0.060)
                else
                ...
                drawTxt("TEMPOMAT", 2, cruiseColor, 0.25, screenPosX - 0.150, screenPosY + 0.065)
